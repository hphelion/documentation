...
[Please download the latest version of the HP Cloud environment CLI software package for Windows PowerShell here (Version 1.3.1.9)](/file/WinCLI-1.3.1.9.zip)!
...
[Download the latest HP Cloud environment CLI software package for Windows PowerShell](/file/WinCLI-1.3.1.9.zip).  (See the [Release Notes](/cli/windows/release-notes) for details on the current release.)
