...
[Please download the latest version of the HP Helion Public Cloud environment CLI software package for Windows PowerShell here (Version 1.3.3.9)](/file/WinCLI-1.3.3.9.zip)! 
...
To issue HP Helion Public Cloud environment CLI Windows PowerShell commands (also sometimes called *cmdlets*), you need to first navigate to a container or the HP Helion Public Cloud provider, which you can do by issuing the following command:
