---
layout: default
title: "HP Helion Cloud OS for Moonshot FAQs"
...
# HP Helion Cloud OS for Moonshot FAQs
...
* [What is HP Helion Cloud OS for Moonshot?](#what-is-hp-cloud-os-for-moonshot)
* [What are the key advantages of HP Helion Cloud OS for Moonshot?](#what-are-the-key-advantages-of-hp-cloud-os-for-moonshot)
* [What does HP Helion Cloud OS for Moonshot support?](#what-does-hp-cloud-os-for-moonshot-support)
* [How does HP Helion Cloud OS for Moonshot help customers?](#how-does-hp-cloud-os-for-moonshot-help-customers) 
* [How do I order and license HP Helion Cloud OS for Moonshot?](#how-do-i-order-and-license-hp-cloud-os-for-moonshot)
* [Is there a list of all HP Helion Cloud OS for Moonshot topics?](#is-there-a-list-of-all-hp-cloud-os-for-moonshot-topics)
...
HP Helion Cloud solutions deliver the essential foundation of technologies and services to enable our customers to confidently build, operate, and 
...
HP Helion Cloud delivers the essential foundation of technologies and services to enable our customers to confidently build, operate, and 
...
## What is HP Helion Cloud OS for Moonshot?

Building on the HP Moonshot server innovation, HP Helion Cloud OS for Moonshot software delivers an OpenStack-based cloud software platform. 
HP Helion Cloud OS for Moonshot facilities the rapid deployment and lifecycle management of multi-tier workloads on Moonshot cartridges that are tailored for each workload.

You can think of HP Helion Cloud OS for Moonshot as a distribution of OpenStack that provides the technology foundation for the Cloud common architecture across private, public, and hybrid cloud delivery. 

HP Helion Cloud OS for Moonshot is targeted to meet the needs of enterprises who want to leverage OpenStack for rapid innovation, and the beneficial 
...
The technology components of HP Helion Cloud OS for Moonshot include:
...
## What are the key advantages of HP Helion Cloud OS for Moonshot?
...
## What does HP Helion Cloud OS for Moonshot support?
...
## How does HP Helion Cloud OS for Moonshot help customers?

For enterprises who want to leverage OpenStack for rapid innovation and the beneficial economics of an open source approach, HP Helion Cloud OS for Moonshot delivers enterprise-grade OpenStack.  The key benefits are:
...
HP Helion Cloud OS for Moonshot provides the foundation for the HP Helion Cloud common architecture enabling enterprise customers to accelerate hybrid delivery &amp; accelerate business outcomes.

## How do I order and license HP Helion Cloud OS for Moonshot?

For information, see [How to order and license HP Helion Cloud OS for Moonshot](/cloudos/moonshot/prepare/order-license/).

## Is there a list of all HP Helion Cloud OS for Moonshot topics?
