...
<p style="font-size: small;"> <a href="/cloudos/moonshot/install/complete-admin-node-installation/">&#9664; PREV</a> | <a href="/cloudos/moonshot/install/">&#9650; UP</a> | <a href="/cloudos/moonshot/install/launch-admin-dashboard/">NEXT &#9654;</a> </p>
...
As indicated in the [Installation Overview](/cloudos/moonshot/install/overview#preview-of-the-installation-steps) topic, you have a choice at this point: 
...
If you elected to use the wizard-based steps described in this topic (recommended), read on. You'll continue to use the HP Cloud OS for Moonshot Operational Dashboard to execute these steps. Follow these procedures in order.
...
When you're ready, manage your cloud environment by launching the HP Cloud OS for Moonshot Administration Dashboard.  To get there, click More > Launch Dashboard for the cloud you created.  For more, see [Launch the Administration Dashboard](/cloudos/moonshot/install/launch-admin-dashboard/).
