---
layout: default
title: "HP Helion Cloud OS for Moonshot Technical Overview"
...
# HP Helion Cloud OS for Moonshot Technical Overview

Welcome! This technical overview introduces you to the HP Helion Cloud OS for Moonshot architecture, its components and services, and the HP Helion Cloud OS for Moonshot relationship with OpenStack.

* [Why is Cloud Computing Important?](#why-is-cloud-computing-important)

* [What is HP Helion Cloud OS?](#what-is-hp-cloud-os)

* [Understanding the HP Helion Cloud OS for Moonshot Architecture](#understanding-the-hp-cloud-os-for-moonshot-architecture)
...
HP Helion Cloud OS for Moonshot is an enterprise-grade cloud technology that is open and extensible. Based on OpenStack, the fastest-growing open-source cloud community, Cloud OS provides a number of value-added services that complement and enhance OpenStack. 

Cloud OS also provides the foundation for a common cloud architecture across private, public, and hybrid cloud delivery.

## Understanding the HP Helion Cloud OS for Moonshot Architecture
...
Let's look at the components. HP Helion Cloud OS for Moonshot provides two important environments:
...
* The HP Helion Cloud OS for Moonshot **kernel** layer, which is similar to an operating system's kernel layer, across the cloud 

* The HP Helion Cloud OS for Moonshot **base** layer, which is comprised of advanced services that sit above the kernel, like subsystem services in an operating system.
...
HP Helion Cloud OS for Moonshot has provided an enhanced version with two UI dashboards, as described later in this topic.
...
On top of the kernel layer is the base layer, where we've created HP Helion Cloud OS for Moonshot value-added services to provide advanced, additional functionality that goes beyond the basic infrastructure service. 
The value-added services from HP Helion Cloud OS for Moonshot are:
...
Eve is the HP Helion Cloud OS for Moonshot infrastructure topology provisioning service.  Eve allows you to:
...
Graffiti is the HP Helion Cloud OS for Moonshot Resource Pool Registry and Capability Tagging Service, providing:
...
The HP Helion Cloud OS for Moonshot Focus service serves as the Topology Design Registry and Repository Service. Focus provides for persistent store and management of TOSCA-based templates. Focus allows you to:
...
and to perform lifecycle management of that architecture.  HP Helion Cloud OS for Moonshot provides dashboards and tools to accomplish those goals:
...
HP Helion Cloud OS for Moonshot provides the Operational Dashboard. It is used to complete the HP Helion Cloud OS for Moonshot installation process after the Admin Node has been booted with the HP Helion Cloud OS for Moonshot *.iso package.  
...
The HP Helion Cloud OS for Moonshot Administration Dashboard enables self-service usage of the cloud. Any authorized user can use the Administrative Dashboard to interact with the cloud and build the user's own virtual resources in the cloud.  The HP Helion Cloud OS for Moonshot 
...
The HP Helion Cloud OS for Moonshot Administration Dashboard provides a simplified means of creating and managing HP Helion Cloud OS for Moonshot resources, infrastructure topology designs, and infrastructure design documents.
...
component.  It allows HP Helion Cloud OS for Moonshot and its customers to perform tasks such as upgrading the software version of the cloud, patch components with fixes, and 
...
The HP Helion Cloud OS for Moonshot architecture ensures that any product based on it will get a fundamental set of capabilities that are guaranteed 
...
HP Helion Cloud OS for Moonshot provides the ability to produce a topology model for a multi-tier infrastructure.  This model can then be mapped to a physical 
