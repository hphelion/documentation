...
* New argument for `Get-Zones` cmdlet. Adding –v notepad will return more details about each zone including containers in that zone and available services. Example: `get-zones -v`.
