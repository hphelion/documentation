...
<!DOCTYPE topic
  PUBLIC "-//OASIS//DTD DITA Topic//EN" "http://docs.oasis-open.org/dita/v1.1/OS/dtd/topic.dtd" ><topic xml:lang="en-us" id="topic15074">
<title>HP Helion <tm tmtype="reg">OpenStack</tm> Carrier Grade 2.0 Alpha: DNSaaS Configuration (Optional)</title>
<prolog>
<metadata>
...
<p>
<!--UNDER REVISION-->
 <!--./CarrierGrade/Admin_Guide/carrier-grade-neutron-post-installation-configure-DNaaS.md-->
 <!--permalink: /helion/openstack/carrier/services/neutron/post/installation/configure-dnsaas/--></p>
<p>Configuring Domain Name System as a service (DNSaaS) is optional.</p>
<p>Our managed DNS service, based on the <tm tmtype="reg">OpenStack</tm> Designate project, is engineered to help you create, publish, and manage your DNS zones and records securely and efficiently to either a public or private DNS server network.</p>
<p>It is important to read through this page before starting your installation as it explains how to install and configure DNS as a service (DNSaaS) for HP Helion <tm tmtype="reg">OpenStack</tm></p>
<p>
<b>Caution</b>: Before migrating to DNSaaS 1.01, you <b>
<varname>must</varname>
</b> first <xref type="section" href="#topic15074/uninstall">uninstall</xref> DNSaaS 1.0. Do <b>not</b> attempt to install version 1.01 over the previous version. </p>
<p>To configure DNSaaS review:</p>
<ul>
<li>
<xref type="section" href="#topic15074/preq">Prerequisites</xref>
</li>
<li>
<xref type="section" href="#topic15074/credentials">Creating Prerequisite Credentials</xref>

<ul>
<li>
<xref type="section" href="#topic15074/target-cred">Target Credentials</xref>
</li>
<li>
<xref type="section" href="#topic15074/service-cred">Service Credentials</xref>
</li>
</ul>
</li>
<li>
<xref type="section" href="#topic15074/publication">Sherpa CSU Publication and Booting the Installer VM</xref>
</li>
<li>
<xref type="section" href="#topic15074/configure">Installing and Configuring DNSaaS</xref>
</li>
<li>
<xref type="section" href="#topic15074/configovercloud">Configure the Overcloud Load Balancer for DNSaaS</xref>
</li>
<li>
<xref type="section" href="#topic15074/keyreg">Registering the Service with Keystone</xref>
</li>
<li>
<xref type="section" href="#topic15074/uninstall">Uninstalling DNaaS</xref>
</li>
<li>
<xref type="section" href="#topic15074/moreinfo">More Information</xref>
</li>
</ul>
...
<ul>
<li>HP Helion <tm tmtype="reg">OpenStack</tm> is successfully installed</li>
<li>Download <xref type="section" href="#topic15074/publication">DNSaaS Installer Image</xref> </li>
<li>
<p>Obtain <xref type="section" href="#topic15074/target-cred">Target Credentials</xref>: credentials of the user+tenant where the service is to be deployed.</p>
...
<li>
<p>Obtain <xref type="section" href="#topic15074/service-cred">Service Credentials</xref>: credentials for the user+tenant used to validate end user tokens.</p>
...
<section id="credentials"> <title>Creating Prerequisite Credentials</title>
<p>You must create both <b>target</b> and <b>service</b> credentials.</p>
</section>
<section id="target-cred"> <title>Target Credentials</title>
...
<section id="service-cred"> <title>Service Credentials</title>
...
<section id="publication"> <title>Sherpa CSU Publication and Booting the Installer VM</title>
...
<section id="publish-csu-contents"> <title>Publish CSU contents</title>
<ol>
...
<section id="boot-the-installer-vm"> <title>Boot the installer VM</title>
<ol>
<li>Log in to the Horizon dashboard using <b>Target Credentials</b>.</li>
...
<section id="configure"> <title>Installing and configuring DNSaaS</title>
<p>
...
<section id="configovercloud"> <title>Configure the Overcloud Load Balancer for DNSaaS</title>
...
<section id="keyreg"> <title>Registering the service with Keystone</title>
...
<section id="initial-service-configuration"> <title>Initial Service Configuration</title>
...
<p>For the "Nameserver FQDNs" gathered during the <xref type="section" href="#topic15074/preq">prerequisites</xref> step, issue a <codeph>server-create</codeph> command for each name to add the server:</p>
<codeblock>
...
<section id="additional-backend-install"> <title>Additional backend install</title>
...
<section id="post-install-cleanup"> <title>Post-install cleanup</title>
...
<section id="uninstall"> <title>Uninstall DNaaS</title>
...
<section id="moreinfo"> <title>More Information</title>
<p>For more information, see:</p>
<ul>
<li>
  <xref href="../../publiccloud/apidocs/c1.1/dns-api.dita"  >HP Helion Public Cloud DNS API Specifications</xref>
</li>
<li>
<xref href="https://wiki.openstack.org/wiki/Designate" scope="external" format="html" >Designate DNSaaS services for <tm tmtype="reg">OpenStack</tm></xref>
</li>
</ul>
<p>
<b>Note</b>: Public Cloud API and HP Helion Openstack API details are similar.</p>
<p>
  <xref type="section" href="#topic15074"> Return to Top </xref>
</p>
<!-- ===================== horizontal rule ===================== -->
</section>
</body>
