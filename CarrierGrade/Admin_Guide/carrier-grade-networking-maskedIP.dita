...
<title>HP Helion <tm tmtype="reg">OpenStack</tm> Carrier Grade (Beta): Tracking masked IP addresses when using network address translation (NAT)</title>
<prolog>
<metadata>
...
<p>
<!--UNDER REVISION-->
 <!--./CarrierGrade/Admin_Guide/carrier-grade-networking-maskedIP.md-->
 <!--permalink: /helion/openstack/carrier/maskedIP/--></p>
...
<ol>
<li>
<p>Log in to the HP Helion <tm tmtype="reg">OpenStack</tm> Commercial dashboard as cloud admin.</p>
</li>
<li>
...
<p>
<xref type="section" href="#topic6207"> Return to Top </xref>
</p>
</li>
</ol>
<!-- ===================== horizontal rule ===================== -->
