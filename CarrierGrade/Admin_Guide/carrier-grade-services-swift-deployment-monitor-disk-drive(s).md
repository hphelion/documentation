---
layout: default
title: "HP Helion OpenStack&#174; Carrier Grade (Alpha): Monitor Disk Drive(s)"
permalink: /helion/openstack/carrier/services/object/swift/disk-drive/
...
# HP Helion OpenStack&#174; Carrier Grade (Alpha): Monitor Disk Drive(s) 
...
* hpssacli utility must be downloaded and installed. To download and install, refer [hpssacli utility](/helion/openstack/carrier/services/swift/diagnosis-disk-health/hpssacli/).


##Monitoring the Disk Drive(s) of Swift

It is important to check the health of the disk drive of Swift cluster on timely basis. To monitor the disk drives on Swift nodes using **Icinga**, [hpssacli utility](/helion/openstack/carrier/services/swift/diagnosis-disk-health/hpssacli/) must be installed in all Swift node(s).
