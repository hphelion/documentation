---
layout: default
title: "HP Helion Cloud Environment CLI Software for Windows PowerShell Block Storage Examples"
permalink: /cli/windows/2/block-storage/
product: win-2-cli

---
# HP Helion Cloud Environment CLI Software for Windows PowerShell Block Storage Examples
...
To execute HP Helion Cloud commands in Windows PowerShell, first open a Windows PowerShell window; under the Start menu, it is typically under `All Programs > Accessories > Windows PowerShell`.  Select the shell appropriate to your system, either the 64-bit or 32-bit version.  Enter the HP Helion Cloud Services CLI by entering:
