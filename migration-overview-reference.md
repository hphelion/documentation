...
**Tip**: For the full list of HP Cloud UNIX CLI commands, see the [HP Cloud UNIX CLI Release Notes]( ).
...
4. Edit the group using the steps in the [following 3ection](#securitygroupconsoleedit).
