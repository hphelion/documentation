---
layout: default
title: "UNIX CLI for HP Helion Cloud: Creating Servers with Custom User Data"
...
---
#UNIX CLI for HP Helion Cloud: Creating servers with custom user data v12.12#
...
The script may take some time to run, but once it is complete you see:
    ...
    ******************************************************************
     HP Helion Cloud CLI
     Command-line interface for managing HP Helion Cloud services
     Version: 1.7.0
