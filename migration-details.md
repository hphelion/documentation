---
layout: default
title: "HP Helion Cloud Services: Assisted Transition from Version 12.12 to 13.5"
permalink: /migration-details/

---
# HP Helion Cloud Services version 12.12 to 13.5 assisted transition

This page provides with the key details you need to perform an assisted transition--using the HP Helion Cloud support team--from version 12.12 to 13.5 of the HP Helion Cloud software services.  If you plan on performing the migration yourself without support services, surf over to the [transition overview](/migration-overview) page for details.
...
Before attempted an assisted transition from version 12.12 to 13.5 of the HP Helion Cloud software, be sure to keep the following critical pieces of information in mind:
...
* The [migration overview](/migration-overview) page contains details on how to perform a self-migration from version 12.12 to 13.5 of the HP Helion Cloud software
