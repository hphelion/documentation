...
permalink: /mc/compute/networks/create-router/
product: mc-compute

---
# Management console: Creating and deleting a router
...
##Creating a router## {#Creating}

How to create a router with the MC.


##Deleting a router## {#Deleting}

How to delete a router with the MC.
