...
4. From the **Available StoreServ CPG Choices** box, select the CPG.<br> The selected CPG is displayed in the **Selected StoreServ Choices** box.

5.  (Optional) Click **Choose All** displayed below the **Available StoreServ CPG Choices** box to select all the CPGs . 

7. (Optional) Click **Remove All** displayed below the **Selected StoreServ Choices** box to remove all the CPGs. 
...
3. From the **Available StoreServ CPG Choices** box, select the CPG.<br> The selected CPG is displayed in the **Selected StoreServ Choices** box.
