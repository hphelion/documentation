---
layout: default
title: "HP Helion OpenStack: End User License Agreement"
...
1. Applicability. This end user license agreement (the "Agreement") governs the use of HP Helion OpoenStack&reg;("Software"), unless it is subject to a separate agreement between you and Hewlett-Packard Company and its subsidiaries ("HP"). By downloading, copying, or using the Software, you agree to this Agreement.   
