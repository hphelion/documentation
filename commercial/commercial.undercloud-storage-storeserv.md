...
5.Click to select the desired CPGs from **Available CPG** box list.<br> The CPG is displayed in the **Selected CPG** box.

6.(Optional) Click **Choose All** displayed below the **Available CPG** box to select all the CPGs . 

7.Click **Remove All** displayed below the **Selected CPG** box to remove all the CPGs.
