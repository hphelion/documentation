...
After installing the seed, launch a console session to the seed cloud host and execute a single command to install the undercoud and overcloud, with all the appropriate nodes.
