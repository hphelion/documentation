...
* [Software Requirements](#software-requirements)
	...
	* [Software requirements for the undecloud and overcloud](#seed-ucoc)
...
- A browser to manage the undercloud or overcloud;
- A simple command line tool, such as [IPMItool](http://sourceforge.net/projects/ipmitool/), to determine the state of cloud nodes;
