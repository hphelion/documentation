...
# HP Helion OpenStack&#174; 1.1 and 1.1.1: Verifying your Installation
...
From the seed VM connect to the undercloud Horizon console.
...
From the seed VM, connect to the overcloud Horizon console.
