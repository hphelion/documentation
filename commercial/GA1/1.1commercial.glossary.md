...
Refers to the Seed Host. See [Seed Host](Seed-Host).

### Seed Host<a name="Seed-Host"></a> ###

Also known as the Seed Cloud Host, or Seed Node, refers to the physical server where the Seed VM is running. See also [Seed VM](Seed-Cloud).
