...
**Note**: You can now add account and container rings to the Swift Proxies. For these instructions, go to [Adding disk account containers](helion/openstack/1.1/services/swift/deployment/add-disk-account-container/).
