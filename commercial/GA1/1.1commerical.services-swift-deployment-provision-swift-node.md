...
4. Add server details in the ***baremetal.csv*** configuration file  per the format described in the [baremetal.csv document](/helion/openstack/1.1/install/csv/) and upload the file to `/root`.
...
Refer again to the [baremetal.csv instructions ](/helion/openstack/1.1/install/csv/)for required format.
