...
When performing the upgrade to the HP Helion OpenStack 1.0.1  undercloud using the Ansible-based helper script, the Ironic service cannot be restarted because of a lock situation in Ironic. <!-- CORE 2043 -->
