...
# HP Helion OpenStack&#174; 1.1 and 1.1.1: Installation Prerequisites

**This document describes the installation process for HP Helion OpenStack 1.1 and HP Helion OpenStack 1.1.1.**

(If you already have 1.1 installed, you can update Helion OpenStack from 1.1 to 1.1.1 by following the update procedures described in the [HP Helion OpenStack 1.1.1 Update Guide](/helion/openstack/1.1.1/update/).)
...
### Install Ubuntu 14.04 LTS or Debian 8  {#ubuntu}

The seed cloud host must have Ubuntu 14.04 LTS or Debian 8 installed before performing the HP Helion OpenStack installation.
...
Before starting the installation, you must first install Debian 8 or Ubuntu 14.04 LTS. 
