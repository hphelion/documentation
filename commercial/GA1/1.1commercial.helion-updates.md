...
**Note**: The Helion Development Platform must be shutdown before updating the overcloud. 
...
**Note**: Restart the Helion Development Platform VMs after updating the overcloud.
