...
Allow a full day for the  HOS 1.1.1 update to complete. During the update process, affected systems will be offline.
...
This procedure involves downloading the script tarball on a seed host and then copying that onto your seed VM.
...
<!-- Patrick - cut this into your HDP update doc from here -->
