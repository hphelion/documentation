...
After the update, the Overcloud controller should be back online without any errors. You should be able to  SSH to the Nova computer from the seed host.   
...
You should be able to SSH to the Nova Computer from  the seed host. You should be able to ping and SSH to  new instances.
...
- Confirm that you can SSH to the Nova computer from seed host.
...
- Verify that you can SSH to the Nova computer from  the seed host.
