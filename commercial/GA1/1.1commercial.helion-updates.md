...
The default ephemeral certificate location is `/tmp`. This works for normal Helion installations. However, when you update Helion, you must specify the certificate location as `/root`. For example, the correct environment variable specification is:
