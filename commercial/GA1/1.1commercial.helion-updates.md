...
Apache2 requires several self-signed SSL certificates to be properly configured that may not have been configured  correctly because of earlier failures in the setup process.
...
RabbitMQ.
  ...
  * Error Messages:
    ...
    * Upgrade execution returns with an error indicating::
        ...
        overridden via single_controller setting - See README.rst"]
