...
This Helion OpenStack version 1.1.1 update procedure supports Helion Development Platform version 1.2 and only this Helion Development Platform version. For users who have Helion OpenStack 1.1 and Helion Development Platform 1.1, when you update to Helion OpenStack 1.1.1, you also need to update to Helion Development Platform 1.2.  

For Helion Development Platform update instructions, see
...
<!-- Patrick - cut this into your Helion Development Platform update doc from here -->
...
The following is an example of ENV variables:
    ...
    SEED_NTP_SERVER=12.34.56.78 BRIDGE_INTERFACE=eth2
 	BM_NETWORK_SEED_IP=12.34.55.66
 	BM_NETWORK_CIDR=12.34.55.0/24
 	BM_NETWORK_GATEWAY=12.34.55.1
 	SEED_NAMESERVER=123.111.222.5 
