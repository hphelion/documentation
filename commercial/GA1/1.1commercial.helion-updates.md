...
The process of updating Helion OpenStack 1.1 to a higher release consists of three steps:
...
The update process does not automatically overwrite your Heat template. If you have modified your Orchestration (Heat) template, then you will need to update the new templates that are provided with the updater with these modifications. 

If you have not made any changes to the original  Heat template, then to update your Heat templates, run:
