...
When the the script finishes, the cloud is ready for use, with the replacement management controller. Proceed to section: Clean up the environment after controller removal and replacement.
