...
<tr style="background-color: white; color: black;">
    ...
    <td>  The parameter is an exponent: 2^X. Assuming that the average available drive capacity is 1-3 TB. For the partition power values, refer <a href="/helion/openstack/services/swift/deployment/ring-power-and-number-of-partitions/">Ring Power and Number of Partitions</a>.
</td>
</tr>
<tr style="background-color: white; color: black;">
