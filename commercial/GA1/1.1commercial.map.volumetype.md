...
The protection level options enables different data protection configurations.  Supported data protection options are:
...
1. Log in to Overcloud Horizon dashboard.<br /> The Overcloud dashboard displays with the options in the left panel.
...
4. In the **Key** box, enter the name of the backend to which you want to associate the volume type, (that is, *volume&#095;backend_name*).
...
**Note**: Once the volume type is mapped to the backend, the cloud user can create volumes.
