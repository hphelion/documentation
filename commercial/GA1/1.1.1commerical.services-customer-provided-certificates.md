...
The services use the endpoints to talk to other services and they'll fail validation because they're designed to find the ECA certificate from a file location. They need to be told to trust the client provided server certificate. Because the cacert location has been hard coded in HP Helion OpenStack 1.1.1,  the suggested solution is to put both public CA-signed certtificates and internal CA-signed certificates in a single file.
