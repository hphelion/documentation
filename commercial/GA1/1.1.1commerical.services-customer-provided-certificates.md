...
Currently we use the haproxy as a software load balancer to tunnel TLS traffic to the service nodes. Haproxy listens on the VIP. A sample configuration might look like this:
