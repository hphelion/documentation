...
This page provides detailed information on using HP StoreVirtual for realizing cloud storage. 
...
To deploy HP StoreVirtual, you first need to  enroll the Baremetal server and then, update the Helion config file and the overcloud. Perform the following commands:
