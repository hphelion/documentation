...
<title>HP Helion <tm tmtype="reg">OpenStack</tm> 1.1: Mapping Backend to Volume Type</title>
<prolog>
<metadata>
...
<p>
<!--PUBLISHED-->
 <!--./commercial/GA1/carrier-grade-map.volumetype.md-->
 <!--permalink: /helion/openstack/carrier/map/volumetype/--></p>
<p>
...
<p>
<xref format="html" href="javascript:window.open('/media/create-volumetype2.png','_blank','toolbar=no,menubar=no,resizable=yes,scrollbars=yes')" >Create Volume Type Dialog Box (opens in a new window)</xref>
</p>
</li>
<li>
...
<p>
<xref format="html" href="javascript:window.open('/media/view-extra-specs-hos-1.1.png','_blank','toolbar=no,menubar=no,resizable=yes,scrollbars=yes')" >View Extra Specs Option (opens in a new window)</xref>
</p>

<p>
<xref format="html" href="javascript:window.open('/media/volume-extra-specs.png','_blank','toolbar=no,menubar=no,resizable=yes,scrollbars=yes')" > Create Volume Type Extra Specs Dialog Box (opens in a new window)</xref>
</p>
</li>
</ol>
...
<p>
<b>Note</b>: Once the volume type is mapped to the backend, you can create volumes.</p>
<p>
  <xref type="section" href="#topic3936"> Return to Top </xref>
</p>
<!-- ===================== horizontal rule ===================== -->
</section>
</body>
