...
1. Perform the steps [1- 4](#brocade-zone) to add brocade zone manager configuration.
2. Add and configure  HP StoreServ (3PAR) and update overcloud. See [HP Helion OpenStack&#174; : Working With StoreVirtual Backends]( /helion/openstack/1.1/undercloud/oc/config/storevirtual/) for detailed procedure.
