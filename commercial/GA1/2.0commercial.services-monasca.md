---
layout: default
title: "HP Helion OpenStack&#174; 2.o: Monasca Overview"
permalink: /helion/commercial/1.1/services/monasca/
...
Monasca is a multi-tenant, scalable, fault-tolerant monitoring-as-a-service solution. It is open-source and integrates with OpenStack. It uses a REST API for high-speed metrics processing and querying, and has a streaming alarm and notification engine. The name "Monasca" is short for "monitoring at scale".  
...
* The Monasca service is active and running in the undercloud.


## Monitoring Disk Usage {#diskuse} 

Monasca checks the following: [[update from here to end from wiki and eng sources]]
