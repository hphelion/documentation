...
The Monasca service is so named for 'monitoring at scale'. This monitoring service, which runs in the undercloud, helps cloud admins monitor the disk usage of Swift storage node(s). [[what else?]]

HP Helion OpenStack&#174; allows you to monitor Swift cluster in any of the followings ways: [[update]]
