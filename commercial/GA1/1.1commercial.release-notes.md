...
* When creating very large numbers of instances in a synchronous manner, sporadic instance creation failure may be experienced. To work around this behavior, lower the VM creation rate until consistent success is achieved <!-- VNETEE-53 DOCS-1050 -->
