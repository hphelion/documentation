...
* Re-sizing a Compute (Nova) instance is not supported, due to security concerns due to the use of a password-less connection between Compute hosts. <!--(NOV-6664) -->
