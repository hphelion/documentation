...
* After installation, VMs hosted on a particular compute host are not pingable and respond with the message, “Route info failed”. To resolve this issue, restart the Neutron-Open vSwitch-agent on that compute host.
