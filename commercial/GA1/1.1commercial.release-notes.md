...
*  Testing has shown that attempting to create large numbers (000's) of VMs at the rate 6VMs/min might result in VM creation failures of up to 10%. This issue is being investigated by the HP Helion OpenStack team with a view to addressing in a future release. In the interim, if you see this behavior, we recommend lower rates of VM creation <!-- VNETEE-53 DOCS-1050 -->
