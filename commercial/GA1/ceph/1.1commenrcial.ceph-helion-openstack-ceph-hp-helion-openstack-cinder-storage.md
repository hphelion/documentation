...
If you want to do a cinder backup, the cinder volume that needs to be backed up should be in a detached state. That volume should not be attached to any of the instances or VM’s.
