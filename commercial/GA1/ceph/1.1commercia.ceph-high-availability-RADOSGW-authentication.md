---
layout: default
title: "HP Helion OpenStack&#174; HP Helion Ceph RADOSGW Keystone Authentication"
...
* As root, convert OpenSSL certificates that Keystone uses to the NSS DB format. To do this, make sure that the `certutil` package is available on  the gateway nodes. 
...
* From the controller node, get the admin tenant ID by entering:
