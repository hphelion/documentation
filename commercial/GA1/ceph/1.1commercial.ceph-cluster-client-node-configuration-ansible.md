...
permalink: /helion/openstack/ceph-cluster-client-node-configuration-ansible/
product: commercial
...
<p style="font-size: small;"> <a href=" /helion/openstack/commercial.ceph-automated-install/">&#9664; PREV</a> | <a href=" /helion/openstack/services/ceph/">&#9650; UP</a> | <a href=" /helion/openstack/ceph-monitoring/">NEXT &#9654;</a> </p>
...
4. Once the nodes are provisioned (for more information on nodes provisioning, refer [Running the Provisioning Tool]( /helion/openstack/commercial.ceph-automated-install/#running-provision-tool)), create the following configuration files under `/helion-ceph/cephconfigureation/ansible-playbooks/` on the `ceph-admin` node 
...
[Ceph Monitoring](/helion/openstack/ceph-monitoring/)
