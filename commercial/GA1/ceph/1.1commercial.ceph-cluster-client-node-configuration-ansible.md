...
4. Monitor and correct XFS fragmentation by entering:
	...
	For example, to check the fragmentation on 13 OSDs, enter:
...
To list the Nova instance using the CLI, perform the following:

1. Create the instance with an RBD backend. (**[[it would be great if we can get the command**)
