...
4. Untar and copy the downloaded file to the `/helion-ceph` folder on the seed VM. Untarring this file creates the `cephsetup` directory.

The following directories are created under `/helion-ceph/cephsetup` on  the seed VM:
