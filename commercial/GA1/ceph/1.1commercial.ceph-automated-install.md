...
For Ceph tarball files, login to [https://helion.hpwsportal.com](https://helion.hpwsportal.com) and download `helion-ceph.tar` (ceph package).  The ceph package contains the following tar files:
