...
# Manually bringing up your HP Helion OpenStack 1.1 Ceph cluster
...
* The operating system on Ceph nodes is hLinux 3.14.29.4-amd64-hlinux.
...
* Ceph cluster OS - hLinux 3.14.29.4-amd64-hlinux kernel version
...
1.To initialize the OSD data directory, enter:  
...
1. To register the OSD authentication key, enter:
...
1. Add OSD node to CRUSH map by entering:
