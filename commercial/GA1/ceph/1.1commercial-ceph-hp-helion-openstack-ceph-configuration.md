---
layout: default
title: "HP Helion OpenStack&#174; HP Helion Manual Ceph Configuration"
permalink: /helion/openstack/1.1/ceph-hp-helion-openstack-ceph-manual-configuration/
product: commercial
...
# HP Helion OpenStack&#174; 1.1 Manual Ceph Configuration
...
<!--this is not present in the cookbook
...
1. Untar `ceph_client_setup.tar` in root home (`/home`) on each of the Helion overcloud controller and compute nodes where the Ceph client needs to be installed.
...
[Helion OpenStack Glance-Ceph Interoperability]( /helion/openstack/1.1/ceph-hp-helion-openstack-glance-ceph-interoperability/)
