...
This section describes the integration of HP Helion OpenStack 1.1 and Ceph Firefly 80.7 on a hLinux3.14.29 kernel.

Before configuring Helion OpenStack Ceph ensure that HP Helion OpenStack 1.1 is installed successfully. The Administrator should have the knowledge of  Helion OpenStack and understand the creation of Glance image, Cinder volume, and Nova instances.
