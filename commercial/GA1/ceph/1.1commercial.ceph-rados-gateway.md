...
1. Log in to the admin node as root.
...
1. Log into the gateway node as root.
...
-->
<!---Binamra - I think pools, users, etc is a seperate topic. Would you make this its own file?-->
