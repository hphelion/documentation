...
Download the Windows Server installation ISO. In this document we will use Windows Server 2012 as the example. Windows Server evaluation images are available on the [Microsoft website]([http://www.microsoft.com/en-us/evalcenter/try](http://www.microsoft.com/en-us/evalcenter/try)) (registration required).
