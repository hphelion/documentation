...
* Under very heavy load, messages will be duplicated, causing an exception. This is now fixed, but not in the release. A workaround is unnecessary as it only occurs when overloading the neutron API servers. <!-- VNETCORE-490 DOCS-1062 -->
