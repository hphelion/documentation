...
**HP Helion OpenStack can meet Microsift SVVP comliance**

A Microsoft Windows Server 2012 guest operating system can be configured to be Windows SVVP (Server Virtualization Validation Program) compliant when hosted on HP Helion OpenStack. <!-- DOCS-949 -->
