...
Click the descriptions below to view some of the services you can manage in the Horizon dashboard. There is both an overcloud Horizon dashboard and an undercloud dashboard. These snapshots are from the overcloud dashboard, which can be accessible outside your network. Both dashboards are reached via your URL in a browser over HTTPS.
<a name="images"></a>
