...
8. Remove `enable_agent_monitor=False` from the `neutron.conf` file on all three overcloud controllers.

	This restarts agent monitoring, which is active by default. 
