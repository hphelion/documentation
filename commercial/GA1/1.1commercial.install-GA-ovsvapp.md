---
layout: default
title: "HP Helion OpenStack&#174;: Deploying and Configuring OVSvApp on ESX hosts"
...
# HP Helion OpenStack&reg; 1.1: Deploying and Configuring OVSvApp on ESX hosts  
...
- The two Virtual Distributed Switches (VDS) must be configured. 
	...
	Example:
		...
		data_port_name={'vmxnet3':'data'}
		mgmt_interface={'vmxnet3':'mgmt'}
		trunk_port_name={'vmxnet3':'vlan_trunk'}
...
4. Select an option:
	...
	**Notes**
	...
	-For choice 2, along with connection details you have to provide the uplink and trunk VDS/DVS name in [network] section of ovs_vapp.ini 
	-For choice 3 you have to fill the clusters field in the [vmware] section of ovs_vapp.ini 
	-For choice 4 you have to provide a single OVSvAPP name or a comma separated list of names
...
3. Edit the `ovs_vapp.ini` file in the downloaded `hp-ovsvapp` directory: 
	...
	b. Enter the path to the `ovsvapp-patch-*.tar.gz` file path in the [update] section.
