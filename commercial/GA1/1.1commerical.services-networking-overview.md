...
You can use a low-level, raw REST API access to Networking. See the [OpenStack Networking API v2.0 Reference](http://developer.openstack.org/api-ref-networking-v2.html).
