...
6. Edit the `/root/baremetal.csv file` in seed cloud with the details of the newly added node. Make sure to add the role of the node where you see &lt;role&gt;. (baremetal.csv instructions [can be found here](/helion/openstack/1.1/install/csv/).
