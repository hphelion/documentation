...
**Note**: The StoreVirtual VSA default license is for five (5) years and includes 50 TB with all supported functionality. During installation, the CMC may display a message that some features are not licensed. This message displays in error and can be ignored.
