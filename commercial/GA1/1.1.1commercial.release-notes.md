...
This release supports the use of a [customer-provided certificate](/helion/openstack/1.1.1/services-customer-provided-certificates) without requiring any changes to the service configurations other than a possible restart.
