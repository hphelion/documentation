...
After you modify a JSON file, you might want to validate the structure by running it through a validator such as [JSONLint](http://http://jsonlint.com/) to be sure you haven't lost a comma or brace, etc. as that will cause the file to fail or have other undesired side effects. 
