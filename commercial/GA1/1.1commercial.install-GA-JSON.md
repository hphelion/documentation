...
# HP Helion OpenStack&reg; 1.1:  Editing the Installation Configuration JSON File#
...
`seed_nameserver` - Use this variable to specify the DNS server for the seed.

`undercloud_nameserver` - Use this variable to specify the DNS server for the undercloud.

`overcloud_nameserver` - Use this variable to specify the DNS server for the overcloud.
		
	Do not copy these addresses they are only examples

	"dns": {
		"seed_nameserver": "19.65.175.150:8080",
		"undercloud_nameserver": "19.65.175.150:8080",
		"overcloud_nameserver": "19.65.175.150:8080",
	}
