...
**Note to Helion Development Platform users**: At this time, Helion OpenStack v1.1.1 is **not** supported for updating Helion Development Platform v1.1 to v1.2.  
...
1. To source the `kvm-customer-ips.json` file and run the update script enter:
