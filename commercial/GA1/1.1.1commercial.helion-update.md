...
To verify that the new file is correct, please run:

		root@hLinux:~# python -c 'import yaml; f=open("/root/helion-update-1.1-to-1.1.1/tripleo/helion-update/tripleo-ansible/playbooks/step_run_occ.yml", "r"); yaml.safe_load(f);'
		root@hLinux:~# echo $?
		0
