...
**Note to Helion Development Platform users**: At this time, the Helion Developer Platform requires Helion Open Stack v1.1.1. Upgrading Helion Development Platform from v1.1 to v1.2 is currently not supported.
...
- Heat state of each node to be updated should not include any FAIL status
