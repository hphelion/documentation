...
**Note**: You can also deploy the Helion OpenStack 1.1.1 release  from scratch. For those instructions, please see [Installing Helion OpenStack](helion/openstack/1.1.1/install/).
...
The Helion OpenStack 1.1.1 update scripts update Helion OpenStack 1.1 to version 1.1.1 and starts the update process of Helion Development Platform 1.1 to 1.2.  To complete the Helion Development Platform update to 1.2, refer to the Helion Development Platform documentation listed in 
