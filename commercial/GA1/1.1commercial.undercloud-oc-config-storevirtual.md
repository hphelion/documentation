...
To create a Volume Type and map it to a given backend for Cinder using the Horizon overcloud dashboard, go to: [Horizon Overcloud Dashboard](/helion/openstack/1.1/map/volumetype/) or Cinder CLI.
