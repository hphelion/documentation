...
To create a Volume Type and map it to a given backend for Cinder using the Horizon overcloud dashboard or Cinder CLI, go to: [Mapping the StoreVirtual Backend to a Volume Type](/helion/openstack/1.1/map/volumetype/).
