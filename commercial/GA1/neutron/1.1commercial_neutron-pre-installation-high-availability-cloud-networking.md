---
layout: default
title: "HP Helion OpenStack&#174; Neutron: High Availability"
permalink: /helion/openstack/1.1/services/neutron/pre/installation/high-availability/
...
* [Completion of Helion OpenStack Neutron Prerequisite](#neutron-preq)
...
You can configure your Swift Rings by specifying a target zone for each drive that is added to the ring. Learn more about configuring zones for various drives using the Pyringos tool here. Please refer to the [Ringos](/helion/openstack/1.1/GA1/services/object/pyringos/) document.
...
* [OpenStack Cloud Administrator Guide](unable to find the link) 


## Completion of Helion OpenStack Neutron Prerequisite {#neutron-preq}

Once Helion OpenStack Neutron networking prerequisite tasks have been completed, Helion OpenStack is ready to be installed. Once installed, the Network Administrator can configure the cloud network to support the OpenStack networking. These configuration requirements, options, and dependencies are discussed in Post Installation Tasks. 

**Note**: All the tasks listed in this section depend on networking prerequisite tasks having been correctly completed. Configuring Helion OpenStack networking is not complicated but it requires that steps be completed exactly as shown. If you have questions about alternate steps, please contact HP Helion Customer Support:

Email: support@hpcloud.com
