...
<tr>
<td>Used for shipping logs into LogStash</td><td>Within the cloud</td><td>Undercloud Controller/VIP</td><td>TCP 5672</td>
</tr>
<tr>
<td>Ephermeral CA Service - used to obtain SSL certificates</td><td>Within the cloud</td><td>Overcloud VIP</td><td>TCP 14000</td>
</tr>
<tr>
<td>Keystone Admin API - used to validate end user authentication tokens</td><td>Within the cloud</td><td>Overcloud VIP</td><td>TCP 35357</td>
</tr>
<tr>
<td>Keystone API - used by backup while uploading to Swift</td><td>Within the cloud</td><td>Overcloud VIP</td><td>TCP 5000</td>
</tr>
<tr>
<td>Swift API - used by backup</td><td>Within the cloud</td><td>Overcloud VIP</td><td>TCP 8080</td>
</tr>
<tr>
<td>Heat metadata API service - used by instances to retrieve their configuration</td><td>Within the cloud</td><td>Overcloud VIP</td><td>TCP 8000</td>
</tr>
<tr>
<td>Heat CloudWatch API service - used by instances  to retrieve their configuration and report status back to Heat</td><td>Within the cloud</td><td>Overcloud VIP</td><td>TCP 8003</td>
</tr>
<tr>
<td>DNSaaS API servers - used to designate the API service</td><td>Baremetal server</td><td>Within the cloud</td><td>TCP 9001</td>
</tr>
...
StoreVirtual port usage is described in [HP4000 SAN - SANiQ TCP and UDP Port Usage](http://www.manualslib.com/manual/492460/Hp-Storevirtual-4000.html?page=255) in PDF.
...
**Note:** The Service Network is intended for granting privileged access to the baremetal network, to privileged in-cloud services and workloads. As such, this network must remain configured with its default configuration of **shared=False, external=False**. 

Do not set either of these values to True; that will result in giving all cloud tenants privileged access to the baremetal network.
