---
layout: default
title: "HP Helion OpenStack&#174; Carrier Grade (Alpha): Deploying Additional Scale-out Object Storage (Swift) Nodes"
permalink: /helion/openstack/carrier/services/swift/deployment-scale-out/
...
<!--
<p style="font-size: small;"> <a href=" /helion/openstack/carrier/services/object/overview/scale-out-swift/">&#9664; PREV</a> | <a href="/helion/openstack/carrier/services/overview/">&#9650; UP</a> | <a href=" /helion/openstack/carrier/services/object/swift/expand-cluster//"> NEXT &#9654</a> </p>
-->

# HP Helion OpenStack&#174; Carrier Grade (Alpha): Deploying Additional Scale-out Object Storage (Swift) Nodes
...
<tr style="background-color: white; color: black;">
    ...
    <td>  The parameter is an exponent: 2^X. Assuming that the average available drive capacity is 1-3 TB. For the partition power values, refer to <a href=" /helion/openstack/carrier/services/swift/deployment/ring-power/">Ring Power and Number of Partitions</a>.
</td>
</tr>
<tr style="background-color: white; color: black;">
...
Using the ***ringos*** utility you can add the [provisioned nodes](/helion/openstack/carrier/services/swift/provision-nodes/) to the Swift cluster. 
...
2. Update the `so_swift_storage_scale` parameter in the environment variables file, used during the initial installation, according to your storage needs.	
	...
	2. Update the `so_swift_storage_scale` parameter in  `/root/configs/kvm-custom-ips.json ` file according to your storage needs.-->
 	...
 	Refer [Provisioning Swift node(s)](/helion/openstack/carrier/services/swift/provision-nodes/) for   details of adding physical server for scale-out Swift in `baremetal.csv` file.
...
For more details, see the [ringos](/helion/openstack/carrier/GA1/services/object/pyringos/) manual.
