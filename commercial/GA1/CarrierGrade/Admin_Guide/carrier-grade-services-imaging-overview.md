---
layout: default
title: "HP Helion OpenStack&#174; Carrier Grade (Alpha): Image Operations (Glance) Service Overview"
permalink: /helion/openstack/carrier/services/imaging/overview/
...
<!--
<p style="font-size: small;"> <a href="/helion/openstack/carrier/services/identity/overview/">&#9664; PREV</a> | <a href="/helion/openstack/carrier/services/overview/">&#9650; UP</a> | <a href="/helion/openstack/carrier/services/networking/overview/"> NEXT &#9654</a> </p>
-->

# HP Helion OpenStack&#174; Carrier Grade (Alpha): Image Operations (Glance) Service Overview #
...
With the Image Operations service you can work with image files, which are virtual disk image files that the [HP Helion Compute](/helion/openstack/carrier/services/compute/overview/) service can use to create a virtual machine.
...
You can use the [HP Helion OpenStack Dashboard](/helion/openstack/carrier/dashboard/how-works/) to work with the Image Operations service.
...
The following lists of tasks can be performed by a user or administrator through the [HP Helion OpenStack Dashboard](/helion/openstack/carrier/dashboard/how-works/), the OpenStack [CLI](
...
* [HP Helion OpenStack Operational Dashboard Help](/helion/openstack/carrier/manage/operational-dashboard/)
* [HP Helion OpenStack Administration Dashboard Help](/helion/openstack/carrier/manage/administration-dashboard/) -->
