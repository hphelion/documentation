...
Figure 1 illustrates the deployment of overcloud compute nodes and VSA nodes to physical servers. 
...
* Failure of the host where the following components run:
