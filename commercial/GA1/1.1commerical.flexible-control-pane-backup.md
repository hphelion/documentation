...
8. Create a point-in-time snapshot of the seed VM, the undervloud node (`baremetal_0`) and overcloud-0 (`baremetal_3`) node:
...
10. Make sure the snapshot for each domain is currently used for data writes:
...
8. Create a point-in-time snapshot of the seed VM, the overcloud-1 (`baremetal_1`) and Swift-Storage-0 (`baremetal_4`) nodes:
...
8. Create a point-in-time snapshot of the seed VM, the overcloud-2 (`baremetal_2`) and Swift-Storage-1 (`baremetal_5`) nodes:
