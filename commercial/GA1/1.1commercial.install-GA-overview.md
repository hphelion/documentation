...
<<<<<<< HEAD
**This document describes the installation process for HP Helion OpenStack 1.1 and 1.1.1.**

(If you already have 1.1 installed, you can update Helion OpenStack from 1.1 to 1.1.1 by following the update procedures described in [HP Helion OpenStack 1.1.1 Update Guide](/helion/openstack/1.1.1/commercial.helion-update).)
=======
This document describes the installation process for HP Helion OpenStack 1.1 and 1.1.1. (If you already have 1.1 installed, you can update Helion OpenStack from 1.1 to 1.1.1 by following the update procedures described in [HP Helion OpenStack 1.1.1 Update Guide]( /helion/openstack/1.1.1/update/).
>>>>>>> e47583e4c1d7aa6143fa3b01d6bd8ae2c4af10b6
