---
layout: default
title: "UNIX CLI for HP Helion Cloud: Performing Large File Uploads"
permalink: /cli/unix/articles/large
product: unix-cli
categories: cli linux unix
tags: large file upload download
---
#UNIX CLI for HP Helion Cloud: Performing large file uploads v12.12#
...
The UNIX CLI for HP Helion Cloud is the perfect way to upload large files.  This article contains some tuning and recovery tips about uploading large files.
