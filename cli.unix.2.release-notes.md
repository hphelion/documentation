---
layout: default
title: "UNIX CLI for HP Helion Cloud Release Notes"
permalink: /cli/unix/2/release-notes/
product: unix-cli

---
#UNIX CLI for HP Helion Cloud v13.5 Release Notes
...
+ The UNIX CLI for HP Helion Cloud has moved to the HP Helion Cloud Github repository
...
These are the release notes for the UNIX CLI for HP Helion Cloud.  The current release number for the [UNIX CLI software](/cli/unix) is version 2.0.0, released on 09/17/13.
...
**Note**: This release of the UNIX CLI for HP Helion Cloud requires the [Ruby Fog v0.0.18](https://docs.hpcloud.com/bindings/fog/install) binding.
