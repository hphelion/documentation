---
layout: default
title: "UNIX CLI for HP Helion Public Cloud Release Notes"
...
+ The UNIX CLI for HP Helion Public Cloud has moved to the HP Helion Public Cloud Github repository
...
**Note**: This release of the UNIX CLI for HP Helion Public Cloud requires the [Ruby Fog v0.0.18](https://docs.hpcloud.com/bindings/fog/install) binding.
