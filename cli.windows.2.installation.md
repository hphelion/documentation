---
layout: default
title: "HP Helion Cloud Environment CLI Software for Windows PowerShell Installation"
permalink: /cli/windows/2/installation/
product: win-2-cli

---
# HP Helion Cloud Environment CLI Software for Windows PowerShell Installation

To get the HP Helion Cloud Environment CLI Software for Windows PowerShell installed and running properly you must complete the following tasks:
...
[Please download the latest version of the HP Helion Cloud environment CLI software package for Windows PowerShell here (Version 1.3.5.7)](/file/WinCLI-1.3.5.7.zip)! 

##Installation Prerequisites## {#InstallationPrerequisites}

The following are prerequisites for installing and running the HP Helion Cloud Environment CLI Software for Windows PowerShell.
...
To use the HP Helion Cloud Environment CLI Software for Windows PowerShell, you must make sure that your Powershell environment is capable of executing 3rd party modules. 
...
Download the latest HP Helion Cloud environment CLI software package for Windows PowerShell.  (See the [Release Notes](/cli/windows/release-notes) for details on the current release.) 
...
The shell detects that this is your first time logging in and prompts you for these items. 
    ...
    ===============================================================
    Welcome to the HP Helion Cloud Services Powershell Environment.
    ===============================================================
...
To issue HP Helion Cloud environment CLI Windows PowerShell commands (also sometimes called *cmdlets*), you need to first navigate to a container or the HP Helion Cloud Services (HPCS) provider, which you can do by issuing the following command:
...
When you upgrade to a new version of the HP Helion Cloud environment CLI software for Windows PowerShell, you must first de-install the previous version of the software.  You can do this using the Windows `Add/Remove Programs` or `Programs and Features` utility (depending on the version of Windows you're using).  Search through the listing of programs for "HPCS-Powershell" and uninstall it.  
