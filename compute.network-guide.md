...
##Customizing your Configuration## {#CustomizingyourConfiguration} (optional)
Modify the default network and create additional networks to exact specifications through the OpenStack Networking API. Customize the configuration either on the command line or through the HP Cloud Services MC to: 
