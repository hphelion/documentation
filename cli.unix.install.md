...
You can find the values you need for your setup by clicking the [API Keys](https://account.hpcloud.com/account/api_keys) button in the [Console Dashboard](https://console.hpcloud.com/dashboard).  
