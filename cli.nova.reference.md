...
###Example
Creates a backup of volume 68453 to a container named `my-backup-container` in your HP Helion Cloud Object Storage account:
...
##get-vnc-console## {#get-vnc-console}
Get a virtual network computing (VNC) console for a server.
###Syntax
`get-vnc-console <server> <console-type>`
