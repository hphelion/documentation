...
Before you can begin working with the Novaclient CLI software, you have to install the package (of course!).  The instructions below work for Ubuntu, CentOS and Windows installations.<!-- Take a look at the [HP Cloud Python Novaclient CLI - Release Notes](/cli/nova/release-notes) for the latest features.-->
