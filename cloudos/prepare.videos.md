...
The following video tutorials walk you through the HP Cloud OS features. 
...
Mark Perriera, HP Cloud 0S chief architect, describes hybrid cloud provisioning using HP Cloud OS. Hybrid cloud means being able to consume services across different cloud instances and in many cases
...
### HP Cloud Coffee Talk - HP Cloud Security
