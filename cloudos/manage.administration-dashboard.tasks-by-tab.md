...
The HP Helion Cloud OS API Documentation application is a tool for describing, producing, and visualizing RESTful web services. 
...
If a service supports the HP Helion Cloud OS API Documentation application, you see REST API under the <b>Actions</b> column.
...
You select this option if your HP Helion Cloud OS Operational Dashboard administrator used the advanced method to create compute regions. The advanced option 
...
<li> <b>HP Helion Cloud OS - OpenStack (Grizzly)</b>: The dashboard provides values for the HP Helion Cloud OS Administration Dashboard environment. Provider details are not required.
...
<li> Select a <b>Cloud Profile</b> to represent the current supported OpenStack version and capabilities of the cloud to which you are deploying.
 <br /> <br /> 
<p> <b>HP Helion Cloud OS Grizzly</b> </p>
...
<ul>
<li> If you are using a local (on premise service), such as HP Helion Cloud OS, you do not need an account on that service to create and edit resource pools. </li> 
...
The Updates and Extensions window provides a convenient place for users who have permission to access the HP Helion Cloud OS Distribution Network (CODN). 
...
You must configure the HP Helion Cloud OS Administration Dashboard to access an HP Helion Cloud OS Distribution Network account before you can use the 
...
A download can consist of one or more pieces that must be distributed to multiple HP Helion Cloud OS repositories. Publish routes the download contents to 
...
* [About the HP Helion Cloud OS Administration Dashboard](#about-the-hp-cloud-os-administration-dashboard)
...
### About the HP Helion Cloud OS Administration Dashboard  
