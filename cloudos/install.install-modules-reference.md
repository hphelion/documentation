...
<td> A user-editable name for the Domain field on the HP Helion Cloud OS Administration Dashboard login screen. </td>
</tr>
...
<tr>
<th style="background-color: #C8C8C8;"> Description </th> 
<td colspan="2" style="background-color: white;"> Installs the self-service HP Helion Cloud OS Administration Dashboard. </td>
</tr>
...
<td> &lt;password> </td>
<td> The password for the administrative user for Swift in the swauth method. **Note:** Not used - HP Helion Cloud OS defaults to Keystone authentication. </td>
</tr>
...
<td> 60 </td>
<td> HP Helion Cloud OS immediately returns a 498 response if the necessary sleep time ever exceeds the given max_sleep_time_seconds.</td>
</tr>
