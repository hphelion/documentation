...
<img src="media/cloudos-single-region1.jpg" width="75%" title="HP Cloud OS Single Region. All controllers in a single virtual machine. Compute node is bare metal." />

##### Diagram 2: Multi-region. All controllers in virtual machines.

<img src="media/cloudos-multi-region2.jpg" width="75%" title="HP Cloud OS Multi-region. All controllers in virtual machines." />

##### Diagram 3: Single region. Controllers are in separate virtual machines.

<img src="media/cloudos-single-region-controllers-vm3.jpg" width="75%" title="HP Cloud OS Single region. Controllers are in separate virtual machines." />

##### Diagram 4: Single region. All controllers in a single bare metal server. 

<img src="media/cloudos-single-region-controllers-baremetal4.jpg" width="75%" title="HP Cloud OS Single region. All controllers in a single bare metal server." />
