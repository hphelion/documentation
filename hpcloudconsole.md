...
After initial setup, revisit the interface to monitor usage, modify, add, and delete networks, instances, volumes, roles, groups, and more. For the latest updates to the current HP Public Cloud Console release, see [What's new with HP Public Cloud Console](/hz/whatsnewjan/2014/).
