              ...
              <xsl:when test="(string-length($WEBHELP_FOOTER_FILE) = 0) 
                  ...
                  <!--<div class="footer">-->
                    ...
                    <!--<table width="">
                      ...
                      <tr><td width="50%" align="right">&#169; 2015 Hewlett-Packard Development Company, L.P.</td>
                        <td align="left"><a href="http://www.hpcloud.com/legal-documents">HP Cloud legal documents and privacy policy</a></td></tr>
                    </table>-->
