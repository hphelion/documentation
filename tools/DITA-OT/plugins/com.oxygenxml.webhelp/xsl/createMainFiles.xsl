	   ...
	   <link rel="stylesheet" type="text/css"
        ...
        <body onload="javascript:showMenu('content');">
          ...
          <div id="header">
            <div id="lHeader">
              <xsl:if test="not($withFrames)">
                <div id="productTitle"><img src="http://www8.hp.com/hpnext/sites/default/files/content/documents/HP%20Helion%20Logo_Cloud_Martin%20Fink_New%20Style%20of%20IT_Hewlett-Packard.PNG" alt="HP Helion" height="42"  />
                  <h1>  
