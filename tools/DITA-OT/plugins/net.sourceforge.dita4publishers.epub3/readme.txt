Unzip this so that the net.sourceforge.dita4publishers.epub3 subdirectory 
...
java -jar lib\dost.jar /i:doc\DITA-readme.ditamap /transtype:epub3

java -jar lib\dost.jar /i:doc\userguide\DITA-userguide.ditamap /transtype:epub3
