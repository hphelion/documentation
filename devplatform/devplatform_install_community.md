...
The HP Helion Development Platform Community edition currently contains four products: Application Lifecycle Service (ALS), Marketplace Service, Messaging Service and Database Service.

The following topics explain how to install and configure the HP Helion Development Platform Community edition.
...
The HP Helion Development Platform is installed in the HP Helion OpenStack Community edition [overcloud](http://docs.hpcloud.com/helion/openstack/glossary/#o-jumplink-span).  The HP Helion Development Platform has the same prerequisites as [HP Helion OpenStack Community](http://docs.hpcloud.com/helion/community/hwsw-requirements/).
...
## <a name="installing-the-hp-helion-development-platform">Installing the HP Helion Development Platform Community Edition</a>

### Downloading and unpacking the installation file

The installation of the HP Helion Development Platform Community Edition for the HP Helion OpenStack Community Edition is provided as a small compressed tar file.  The images for the actual services will be downloaded at the installers request.
...
To begin the installation, unpack the tar file:
    ...
    # tar -zxvf hp_helion_devplatform.tar.gz.csu
...
You must have the following quota available:
