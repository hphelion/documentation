...
5. Validate Keystone access on port 5000 using *curl*.
		...
		curl http://{ip address or host name of identity service aka keystone}:5000
Example:
...
7. Run this command to install the Helion Development Platform.<br /> By default the Username is *admin* and the Region is *regionOne*. 
