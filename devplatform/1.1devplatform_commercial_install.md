...
[See version 1.0 of this page](/helion/devplatform/install/)
...
7. Run this command to prepare the installer and ensure the prerequisites are met.
		...
		sudo ./DevelopmentPlatform_Setup.sh -p {admin_user_password} -a {auth_host_ip_address} -c {HDN user name} -o {HDN password} -e {cacert file}
