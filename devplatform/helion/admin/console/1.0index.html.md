...
title: "HP Helion 1.0 Development Platform: Management Console (Admin View) "
...
-   **View All Deployed Applications**: Opens the [Applications](#applications) view.
...
-   **Sample Applications URLs**: URIs for JSON files which populate the [*App
    Store*](/als/v1/admin/console/app-store/#app-store). The URIs need not be public, but
