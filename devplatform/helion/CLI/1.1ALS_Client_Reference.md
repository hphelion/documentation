...
- [Cluster Commands](#commands)
	...
	- [Add a Node to an Existing Cluster](#addrole)
...
<tr><td>--env 'C:\Users\&#60;username&#62;\.cf-mgmt.yml' <td>Default location for configuration file for global options. Enter a new file path to change the location of the configuration file.</td><td>n/a</td></tr>
...
Options that can be passed when adding roles to an existing cluster (*add-role dea*).
**Note**: Adding a role may require adding one or more nodes to the cluster as part of the process.
