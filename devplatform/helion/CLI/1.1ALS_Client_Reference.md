...
##Add Nodes to an Existing Cluster {#addnode}
Options that can be passed when adding nodes to an existing cluster (*add-role dea*).

###Use Syntax

<pre>cf-mgmt [global options] <b>add-role</b> [command options] [arguments...]</pre>

For help with this command within the command-line interface, enter

<pre>cf-mgmt help add-role</pre>
...
Options that can be passed when adding nodes to an existing cluster (*add-service*).
...
<pre>cf-mgmt help add-service</pre>
