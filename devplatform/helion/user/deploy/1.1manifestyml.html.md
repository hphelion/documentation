...
# HP Helion 1.1 Development Platform: Manifest.yml Options {#manifest-yml-options}
[See the Helion OpenStack 1.0 version of this page](/als/v1/user/deploy/manifestyml/)
