...
title: "HP Helion 1.0: Development Platform: Manifest.yml Options "
---
<!--PUBLISHED-->

# HP Helion 1.0 Development Platform: Manifest.yml Options {#manifest-yml-options}
[See the Helion 1.1 Development Platform version of this page](/helion/devplatform/1.1/als/user/deploy/manifestyml/)
