...
# HP Helion 1.1 Development Platform: Developing in Node {#node-js}
[See the Helion OpenStack 1.0 version of this page](/als/v1/user/deploy/languages/node/)
...
Deployable [sample applications](/helion/devplatform/1.1/appdev/#node) are available in this language.
