...
<tt class="docutils literal"><span class="pre">requirements.txt</span></tt> file (using our earlier cherrypy example):
<div class="highlight-yaml"><div class="highlight"><pre><span class="l-Scalar-Plain">cherrypy</span>
...
Using the cherrypy example, you could implement a simple web server to show
volumes.  Obviously, this needs to run under HTTPS:
