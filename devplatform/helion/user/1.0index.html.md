...
-   [Application Lifecycle Service Client](/als/v1/user/client/)
    ...
    -   [Targeting the API Endpoint](/als/v1/user/client/#targeting-the-api-endpoint)
...
-   [Application Lifecycle Service Client Reference](/als/v1/user/reference/client-ref/)
