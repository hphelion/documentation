...
<p>
<ol>
<li>Log into the <a href="https://horizon.hpcloud.com/" target="_blank">Horizon console</a> using the HP Helion Public<br />Cloud username and password that you created during registration. <br /> <b>Note</b>: If you are accessing the Horizon console from an<br /> installation of HP Helion OpenStack&#174; instead, the Horizon console will look slightly different from the<br />following screenshots, but the installation procedure is the same.</li><br /><li>
<a href="https://community.hpcloud.com/article/how-create-or-delete-network#create" target="_blank";><br />Create a network with public internet access</a>. These instructions will open in a new window so you don't lose your place.
