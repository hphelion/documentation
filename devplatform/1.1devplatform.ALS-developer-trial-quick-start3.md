...
permalink: /helion/devplatform/ALS-developer-trial-quick-start/3
product: devplatform
...
1. <a href="http://docs.hpcloud.com/helion/devplatform/ALS-developer-trial-quick-start/">Create Free Public Cloud Account</a> </p><p>
2. <a href="http://docs.hpcloud.com/helion/devplatform/ALS-developer-trial-quick-start/2">Download and install the configuration tool (<i>cf-mgmt</i>)</a></p>
...
<p><form action="http://docs.hpcloud.com/helion/devplatform/ALS-developer-trial-quick-start/4" method="get">
