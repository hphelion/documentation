...
<li>Enter a name in the <b>Key Pair Name</b> field and then click <b>Create Key Pair</b>.<br /><img src="http://docs.hpcloud.com/content/documentation/media/quickstartkeypair_small"/><br /></li>
