...
<b>Limited time offer:</b> Use code <b>WINHDP</b> to get a three-month free trial account on the HP Public Cloud.<br /> This limited promotional code is valid for the first 250 customers only and only for use with the Helion Development Platform trial. If you are a current HP Public Cloud user and want to explore the new Windows&#174; features, please create a new account using this promotion code.
</p>
