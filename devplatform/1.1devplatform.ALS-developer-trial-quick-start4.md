...
<br />
<br />
3. Run the following set of commands using the <i>cf-mgmt</i> tool. <br />In the unlikely event that the cluster creation fails, refer to the <a href="http://15.184.32.138/helion/devplatform/1.1/ALS-developer-trial-quick-start/troubleshooting" target="_blank">Troubleshooting tips</a>.<p> 
<li>For Windows</li>
<pre>
cf-mgmt.exe ^
