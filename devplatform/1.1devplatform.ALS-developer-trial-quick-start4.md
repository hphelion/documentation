...
<li>Run the following set of commands using the <i>cf-mgmt</i> tool to create the cluster. <br />In the unlikely event that the cluster creation fails, refer to the <a href="http://15.184.32.138/helion/devplatform/1.1/ALS-developer-trial-quick-start/troubleshooting">Troubleshooting tips</a>.<p>
<ul> 
<li>For Windows:</li>
...
create-cluster ^
	...
	--admin-email &lt;your login for the trial environment&gt; ^
	--admin-password &lt;your password for the trial environment&gt; ^
	--load trial.yml
</pre>
