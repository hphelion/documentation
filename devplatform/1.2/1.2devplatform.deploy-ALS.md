...
##Prerequisites {#prereq}
You need to [install](/helion/devplatform/1.2/install/) the Helion Development Platform and the [Application Lifecycle Service](/helion/devplatform/1.2/install/#install-als). 
...
6.	Click on the **Proxies** tab of the Create Cluster dialog and enter the addresses of the proxy servers for your environment (if any). Be sure to use the correct protocol prefixes and specify the correct port numbers. <br /><img src="media/ALSConfig5_1.png"/>
