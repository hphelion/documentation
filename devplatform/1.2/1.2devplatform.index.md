...
The [Application Lifecycle Service (ALS)](/helion/devplatform/als/) is a Cloud Foundry-based, managed runtime environment for applications. 
...
The [Marketplace](/helion/devplatform/marketplace/) is a product catalog that will be used to deliver the best of breed applications and services required to support world-class, enterprise-grade applications.
...
Use the Helion CLI to deploy your app to the development platform through the command line. [Setup](/helion/devplatform/als/user/client/#helion-client-setup) instructions are available for here both Windows&#174; and Unix/Mac operating systems.
