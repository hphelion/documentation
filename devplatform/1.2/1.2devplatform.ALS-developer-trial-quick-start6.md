...
<p>If you are interested in exploring the new functionality, you can jump right into deploying Windows&#174; applications.</p><p><form action="http://docs.hpcloud.com/helion/devplatform/1.2/windows/deployingnet" target="_blank" method="get">
