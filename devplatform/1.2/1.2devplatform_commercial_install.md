...
**Note:** Helion OpenStack version 1.1.1 is required for Helion Development Platform 1.2. Installing or upgrading to Helion Development Platform 1.2 on Helion OpenStack versions 1.1 or 1.0 is not supported. See <a href="/helion/openstack/1.1.1/update/">HP Helion OpenStack 1.1: Update Procedure</a> for information on upgrading your Helion OpenStack installation.
