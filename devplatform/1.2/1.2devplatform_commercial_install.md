...
6. If you are installing from a machine other than the seed node, you will need to retrieve the CA certificate file from the overcloud controller. To do this, follow these steps:
