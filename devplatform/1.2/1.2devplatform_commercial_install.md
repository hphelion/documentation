...
1. In the **Configure Services** panel locate the **Cue** item in the Configure Services table and select **Download Service** and wait for the download to complete.
