...
permalink: /helion/devplatform/als/client/download
...
Full Application Lifecycle Service (ALS) Client [command reference](/helion/devplatform/als/user/reference/client-ref/)
...
Full ALS Cluster Management Tool [command reference](/helion/devplatform/als/client/reference/).
