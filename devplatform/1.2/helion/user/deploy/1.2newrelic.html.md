...
-   Download a fresh <i>newrelic\_agent\_&lt;version number\>.zip</i> file that includes
    your license key. Log in to [rpm.newrelic.com](http://rpm.newrelic.com/) and click the  **Account Settings** link to find and download the file.
