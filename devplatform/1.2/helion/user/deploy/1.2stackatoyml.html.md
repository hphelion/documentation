...
title: "HP Helion 1.2 Development Platform: HP Options "
...
# HP Helion 1.2 Development Platform: HP Options {#yml-options}
[See the Helion 1.0 Development Platform version of this page](/als/v1/user/deploy/stackatoyml/)
...
[*buildpack*](/helion/devplatform/1.2/als/user/deploy/buildpack/#buildpacks) used to deploy the application.
For example:
...
*detect* scripts in any of its [built-in buildpacks](/helion/devplatform/1.2/als/user/deploy/buildpack/#buildpacks-built-in).

framework:[](#framework "Permalink to this headline")
------------------------------------------------------

Allows the app to specify a framework and runtime to be used. Specifying a value for the **framework** key triggers the use of the [Legacy Buildpack](/helion/devplatform/1.2/als/user/deploy/buildpack/#buildpacks-legacy).

**Note**:  The keys in the **framework** section are used with the [Legacy Buildpack](/helion/devplatform/1.2/als/user/deploy/buildpack/#buildpacks-legacy) only. Applications using language or framework-specific buildpacks do not require these values, and should instead specify the
[buildpack](#yml-buildpack) or rely on the detection scripts of the [built-in buildpacks](/helion/devplatform/1.2/als/user/deploy/buildpack/#buildpacks-built-in).
...
[*PROCESSES\_WEB*](/helion/devplatform/1.2/als/user/reference/environment/#term-processes-web) and
HELION\_START\_FILE environment variables. Any changes to
HELION\_START\_FILE at runtime will not change the value of
[*PROCESSES\_WEB*](/helion/devplatform/1.2/als/user/reference/environment/#term-processes-web) as
...
[*manifest.yml*](/helion/devplatform/1.2/als/user/deploy/manifestyml/#manifest-yml) file.
...
push*](/helion/devplatform/1.2/als/user/reference/client-ref/#command-push) command, overriding
...
client*](/helion/devplatform/1.2/als/user/reference/client-ref/#command-ref-client) when using the
[*push*](/helion/devplatform/1.2/als/user/reference/client-ref/#command-push) command. These
...
client*](/helion/devplatform/1.2/als/user/reference/client-ref/#command-ref-client).
...
Used with the [*Legacy buildpack*](/helion/devplatform/1.2/als/user/deploy/buildpack/#buildpacks-legacy)
...
[*generic*](/helion/devplatform/1.2/als/user/deploy/other-frameworks/#generic-framework) framework, but is
...
example using the
[*standalone*](/helion/devplatform/1.2/als/user/deploy/other-frameworks/#standalone-framework) framework:
...
[*Application log drains*](/helion/devplatform/1.2/als/user/deploy/app-logs/#application-logs-drain) can be
