...
[*package.json* file](https://docs.npmjs.com/getting-started/creating-node-modules). Application Lifecycle Service
...
##Host and Port Environment Variables {#host-and-port-environment-variables}
