...
This guide covers the basics of deploying apps using the Application Lifecycle Service (ALS).
...
To use it, open the API Endpoint URL (e.g. *https://api.10.0.0.1.xip.io*) in your favorite browser. Log in with the username and password that have been set up for you on the system.
...
There is also an [Eclipse plugin](/helion/devplatform/1.2/eclipse/) available for the Management Console to facilitate pushing JAVA applications.
...
Additional sample applications are available on [GitHub](https://github.com/HelionDevPlatform), each with a README.md file explaining how to deploy it on Application Lifecycle Service.
