...
permalink: /helion/devplatform/als/admin/console/app-store/
...
Users have access to the main Sample Applications interface (see the [Application Lifecycle Service User Guide](/helion/devplatform/als/user/), but do not have access to add new applications or add/modify the definition file.
...
specified in the main [Settings](/helion/devplatform/als/admin/console/#settings) page of
the Management Console or set using [kato
config](/helion/devplatform/als/admin/reference/kato-ref/#kato-command-ref-config).

### Sample Applications Definition File {#app-store-definition}

[YAML](/helion/devplatform/als/user/reference/glossary/#term-YAML) files describe the settings for each set of apps, including the container and a link to the source  repository for
...
**framework**
:   The framework the app uses, if the app is deployed using the [Legacy Buildpack](/helion/devplatform/als/user/deploy/buildpack/#buildpacks-legacy)(e.g. perl, python, node, rails3).
...
**runtime**
:   The runtime, if the app is deployed using the [Legacy Buildpack](/helion/devplatform/als/user/deploy/buildpack/#buildpacks-legacy) (e.g. java, python32, ruby19, php, perl518).
**services**
...
1.  Log into the [Management
    Console](/helion/devplatform/als/user/console/#management-console),
...
with [kato config](/helion/devplatform/als/admin/reference/kato-ref/#kato-command-ref-config). For
example:
