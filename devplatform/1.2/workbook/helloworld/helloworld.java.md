...
title: "HP Helion 1.2 Development Platform: Java Hello World Sample"
...
# HP Helion 1.2 Development Platform: Java Hello World Sample
...
Use the Helion client to deploy your app to Helion Development Platform.  If you have Eclipse installed, you have the option to [use the plugin](/helion/devplatform/1.2/eclipse/) to deploy.
...
2.	You can deploy your app using either the Helion CLI or the [Eclipse plugin](/helion/devplatform/1.2/eclipse/).

[Exit Samples](/helion/devplatform/1.2/appdev) | [Previous Sample](/helion/devplatform/1.2/workbook/messaging/java/) | [Next Sample](/helion/devplatform/1.2/workbook/database/java/)
