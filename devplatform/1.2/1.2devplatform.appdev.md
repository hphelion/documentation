...
- Access to the [Helion command-line interface (CLI)](/helion/devplatform/als/user/client/)
- (Optional) Access to the [Eclipse](/helion/devplatform/eclipse/) deployment plugin for JAVA applications.
...
More Helion [Java](/helion/devplatform/als/user/deploy/languages/java/) references.
...
More Helion [Node](/helion/devplatform/als/user/deploy/languages/node/) references.
...
More Helion [PHP](/helion/devplatform/als/user/deploy/languages/php/) references.

###Other references
- [Installing the Marketplace](/helion/devplatform/marketplace/)
- [ALS command-line interface (CLI) reference](/helion/devplatform/als/user/reference/client-ref/#command-ref-client)
- [Application Lifecycle Service (ALS) User's Guide](/helion/devplatform/als/user/)
- [Remote Debugging](/helion/devplatform/als/user/deploy/app-debug/)
- [The Management Console](/helion/devplatform/als/user/console/)
