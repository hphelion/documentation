...
permalink: /helion/devplatform/ALS-developer-trial-quick-start/5
product: devplatform
...
<p>
1. <a href="http://docs.hpcloud.com/helion/devplatform/ALS-developer-trial-quick-start/">Register for your free Helion Public Cloud Account</a>
</p><p>
2. <a href="http://docs.hpcloud.com/helion/devplatform/ALS-developer-trial-quick-start/2">Download and install the configuration tool (<i>cf-mgmt</i>)</a>
</p><p>
3. <a href="http://docs.hpcloud.com/helion/devplatform/ALS-developer-trial-quick-start/3">Create the Sandbox Environment</a></p>
<p>
4. <a href="http://docs.hpcloud.com/helion/devplatform/ALS-developer-trial-quick-start/4">Create a Cluster</a></p>
...
</p><p><form action="http://docs.hpcloud.com/helion/devplatform/appdev/" target="_blank" method="get">
    <input type="submit" value="Go to the Sample Apps" 
         name="Submit" id="frm1_submit" />
</form></p><hr>
<ul>
<li>If you have <b>encountered problems</b> with this installation, refer to the <a href="http://docs.hpcloud.com/helion/devplatform/ALS-developer-trial-quick-start/troubleshooting">Troubleshooting tips</a>.</li><br />
<li>If you are ready to <b>take down</b> your sandbox environment, refer to the <a href="http://docs.hpcloud.com/helion/devplatform/ALS-developer-trial-quick-start/6">termination instructions</a>.</li><br />
