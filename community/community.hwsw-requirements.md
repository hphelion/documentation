...
The [multi-node baremetal installation of HP Helion OpenStack Community](/helion/community/install/) is configured for a minimum of 7 and maximum of 36 baremetal systems, plus a system to run the installation. For this installation, you must have the following minimum requirements:
