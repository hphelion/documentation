---
layout: default
title: "Getting Started with HP Helion OpenStack&#174; Community Compute Service "
permalink: /cloudos/community/services/compute/getting-started/
product: community

---
# Getting Started with HP Helion OpenStack&#174; Community Compute #

<!-- modeled after HP Cloud Networking Getting Started (network.getting.started.md) -->

Leveraging OpenStack&reg; Compute, the HP Helion OpenStack&#174; Community Compute service provides a way to instantiate virtual servers on publicly accessible physical machines hosted in HP data centers. Key terms include:
...
You can use the [HP Helion OpenStack&#174; Community Dashboard](/cloudos/community/services/dashboard/overview/) to work with the HP Compute service.
