---
layout: default
title: "HP OpenStack Community Edition: Support Matrix"
permalink: /cloudos/community/support-matrix/
product: community
...
# HP OpenStack&reg; Community Edition: Support Matrix

This document provides an overview of the supported hardware and software for the HP OpenStack Community Edition, including information for hardware and software setup. 
...
For the performance and stability of the HP OpenStack Community Edition environment, it is very important to meet the minimum recommendations for memory, processors, and disk space for each of the components in the table below. 
...
For detailed information, see the [Reference architecture](/cloudos/community/reference-architecture/).
